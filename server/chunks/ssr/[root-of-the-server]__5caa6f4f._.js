...
const metadata = {
    ...
    description: "Desde 2015: conectando desenvolvedores, compartilhando conhecimento e celebrando a comunidade Python Nortista. Feito pela comunidade e para a comunidade.",
    generator: "v0.app",
    keywords: [
        "Python",
        "conferência",
    ...
    openGraph: {
        ...
        description: "Desde 2015: conectando desenvolvedores, compartilhando conhecimento e celebrando a comunidade Python Nortista.",
        type: "website"
    },
    icons: {
        icon: [
