  ...
  const keynotes = [
    {
      ...
      description: "Uma grande referência nacional da tecnologia e inovação compartilhará uma reflexão profunda sobre o impacto da comunidade no desenvolvimento regional. Aguarde a revelação oficial!",
    ...
    },
    {
      ...
      description: "Prepare-se para uma palestra técnica provocadora sobre as fronteiras do desenvolvimento de software e tendências emergentes. O segredo será desvendado nos próximos dias.",
      image: "/secret_speaker.png",
    },
    {
      id: 3,
      ...
      description: "Uma das mentes mais influentes no ecossistema global de Inteligência Artificial trará insights valiosos direto das fronteiras do mercado de tecnologia.",
      image: "/secret_speaker.png",
    },
    {
      id: 4,
      ...
      description: "Como a tecnologia e a computação em Python impulsionam a transformação e democratização digital na região Norte. Um fechamento com chave de ouro.",
      image: "/secret_speaker.png",
    },
  ];
  ...
  const scheduleData: DaySchedule[] = [
    {
      ...
      date: "03/07",
      sessions: [
        { time: "08:00 — 08:30", title: "Credenciamento e recepção", type: "Credenciamento" },
        { time: "08:30 — 08:45", title: "Abertura Oficial do Evento", type: "Palestra", location: "Auditório Principal", target: "Todos" },
        { time: "08:45 — 09:45", title: "Keynote I - Abertura", type: "Keynote", location: "Auditório Principal", target: "Todos" },
        {
          time: "09:45 — 12:00",
          ...
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a criar do zero uma aplicação web completa com banco de dados utilizando Django."
        },
        {
          time: "09:45 — 12:00",
          ...
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a carregar, limpar, manipular e visualizar conjuntos de dados reais utilizando a biblioteca Pandas."
        },
        {
          time: "09:45 — 10:15",
          title: "Palestra 01",
          ...
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a estruturar prompts eficazes para otimização de tarefas de desenvolvimento com LLMs."
        },
        {
          time: "10:15 — 10:45",
          title: "Palestra 02",
          ...
          target: "Avançado",
          track: "Web, Cloud & plataforma digitais",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão as melhores práticas de performance, concorrência e testes de carga em endpoints assíncronos."
        },
        { time: "10:45 — 11:00", title: "Coffee Break", type: "Intervalo" },
        {
          ...
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão estratégias para engajar pessoas, criar conexões duradouras e organizar eventos inclusivos locais."
        },
        {
          time: "11:30 — 12:00",
          title: "Palestra 04",
          ...
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a empacotar e rodar aplicações em containers isolados de forma simples e rápida."
        },
        { time: "12:00 — 13:00", title: "Almoço", type: "Intervalo" },
        {
          ...
          registrationRequired: true,
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a orquestrar múltiplos modelos de linguagem para executar ações automatizadas e tomadas de decisão."
        },
        {
          time: "13:00 — 15:00",
          ...
          registrationRequired: true,
          track: "Open Source, DevOps & Ecossistemas colaborativos",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a estruturar pipelines de teste e deploy automáticos utilizando GitHub Actions."
        },
        {
          time: "13:00 — 13:30",
          title: "Palestra 05",
          ...
          target: "Avançado",
          track: "Web, Cloud & plataforma digitais",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a separar responsabilidades, facilitando a manutenção e testes de grandes projetos de software."
        },
        {
          time: "13:30 — 14:00",
          title: "Palestra 06",
          ...
          target: "Todos",
          track: "Open Source, DevOps & Ecossistemas colaborativos",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão como encontrar projetos, abrir issues, e submeter pull requests com confiança."
        },
        {
          time: "14:00 — 14:30",
          title: "Palestra 07",
          ...
          target: "Todos",
          track: "Comunidades, carreira e liderança Tech",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão habilidades de mentoria, delegação de tarefas e planejamento de crescimento profissional."
        },
        {
          time: "14:30 — 15:00",
          title: "Palestra 08",
          ...
          target: "Iniciante",
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão os conceitos fundamentais de algoritmos de classificação e regressão de forma simples."
        },
        { time: "15:00 — 15:30", title: "Coffee Break", type: "Intervalo" },
        { time: "15:30 — 16:30", title: "Keynote II - Encerramento do Dia 1", type: "Keynote", location: "Auditório Principal", target: "Todos" },
        { time: "16:30 — 17:00", title: "Dinâmica de encerramento primeiro dia", type: "Palestra", location: "Auditório Principal", target: "Todos" },
      ],
    },
    {
      dayName: "Dia 2",
      ...
      sessions: [
        { time: "08:00 — 08:30", title: "Credenciamento e recepção", type: "Credenciamento" },
        { time: "08:30 — 09:30", title: "Keynote III - Abertura do Dia 2", type: "Keynote", location: "Auditório Principal", target: "Todos" },
        { time: "12:15 — 14:00", title: "Intervalo (Almoço)", type: "Intervalo" },
        {
          time: "14:00 — 14:45",
          title: "Palestra 09",
          type: "Palestra",
          ...
          target: "Avançado",
          track: "Web, Cloud & plataforma digitais",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão estratégias de refatoração e migração segura de infraestrutura legada para provedores de nuvem."
        },
        {
          time: "14:00 — 14:45",
          title: "Palestra 10",
          ...
          target: "Intermediário",
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a pré-processar texto, remover ruídos e extrair sentimentos usando spaCy."
        },
        {
          time: "14:45 — 15:45",
          title: "Minicurso 01",
          ...
          registrationRequired: true,
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a criar seu primeiro modelo preditivo básico usando Scikit-Learn."
        },
        {
          time: "14:45 — 15:45",
          title: "Minicurso 02",
          ...
          registrationRequired: true,
          track: "Web, Cloud & plataforma digitais",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a implementar autenticação JWT e prevenir vulnerabilidades como injeção e CSRF."
        },
        {
          time: "14:45 — 15:30",
          title: "Palestra 11",
          ...
          target: "Iniciante",
          track: "Open Source, DevOps & Ecossistemas colaborativos",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a coletar e transmitir dados físicos usando MicroPython e placas de desenvolvimento."
        },
        {
          time: "15:30 — 16:45",
          title: "Palestra 12",
          ...
          target: "Intermediário",
          track: "Web, Cloud & plataforma digitais",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a construir e gerenciar funções serverless scaláveis integradas com gatilhos de nuvem."
        },
        {
          time: "15:30 — 16:45",
          title: "Palestra 13",
          ...
          target: "Todos",
          track: "Dados, inteligência artificial e machine learning",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão como o ecossistema Scipy/Numpy revolucionou as pesquisas científicas e computacionais."
        },
        {
          time: "16:15 — 17:00",
          title: "Palestra 14",
          ...
          target: "Avançado",
          track: "Open Source, DevOps & Ecossistemas colaborativos",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão a estruturar portais internos de desenvolvedor (IDPs) para simplificar a criação de serviços."
        },
        {
          time: "16:15 — 17:00",
          title: "Palestra 15",
          ...
          target: "Todos",
          track: "Comunidades, carreira e liderança Tech",
          learningOutcomes: "Ao final desta atividade, os participantes aprenderão os bastidores de logística, captação de patrocínios e gestão de voluntariado de eventos regionais."
        },
        { time: "17:00 — 18:00", title: "Coffee Break & Networking", type: "Intervalo" },
      ],
    },
    {
      dayName: "Dia 3",
      date: "05/07",
      sessions: [
        { time: "09:00 — 10:00", title: "Keynote IV - Abertura do Dia 3", type: "Keynote", location: "Auditório Principal", target: "Todos" },
        { time: "10:00 — 10:30", title: "Coffee Break", type: "Intervalo" },
        {
          ...
          target: "Todos",
          track: "Comunidades, carreira e liderança Tech",
          learningOutcomes: "Ao final desta atividade, os participantes compreenderão os desafios, potenciais e caminhos práticos para a transformação digital regional."
        },
        { time: "12:00 — 13:00", title: "Encerramento Geral, Sorteios e Agradecimentos", type: "Credenciamento" },
      ],
    },
  ];

  const filterTypes = [
    { type: "Keynote", activeBg: "bg-[#004B23] text-white", inactiveBg: "bg-[#EAF5EC] text-[#004B23]" },
    { type: "Palestra", activeBg: "bg-[#FFB800] text-white", inactiveBg: "bg-[#FFF9E6] text-[#A67C00]" },
    { type: "Tutorial", activeBg: "bg-[#FF6B00] text-white", inactiveBg: "bg-[#FFF2EB] text-[#FF6B00]" },
    { type: "Credenciamento", activeBg: "bg-[#9E2A2B] text-white", inactiveBg: "bg-[#FFF0F0] text-[#9E2A2B]" },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="flex items-center gap-2 pt-8">
            <Star className="w-6 h-6 text-[#004B23] fill-none" strokeWidth={2} />
            <h3 className="text-xl md:text-2xl font-bold text-[#004B23]" style={{ fontFamily: "var(--font-display)" }}>
              Keynotes
            </h3>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-20 h-full p-6 flex flex-col justify-end space-y-3 text-white">
                      ...
                      {/* Name */}
                      <div>
                        <h4 className="text-lg md:text-xl font-bold leading-tight">{keynote.name}</h4>
                        <p className="text-[10px] text-[#FFB800] font-semibold tracking-wider uppercase">{keynote.role}</p>
                      </div>
              ...
              {keynotes.map((_, idx) => (
                <div
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                    idx === activeKeynote ? "bg-[#FF6B00] w-6" : "bg-[#FF6B00]/30"
                  }`}
                />
              ))}
            </div>
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-bold transition-all duration-300 border border-transparent shadow-sm ${
                    isSelected ? item.activeBg : `${item.inactiveBg} hover:opacity-90`
                  }`}
                >
                  {item.type}
                </button>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-6 flex-grow">
                    ...
                    <div className="flex flex-col gap-2 flex-grow">
                      <div className="flex flex-wrap items-center gap-3">
                        <span className={`text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider ${badgeBg}`}>
                          {session.type}
                        </span>
                      ...
                      {session.learningOutcomes && (
                        <p className="text-xs text-[#5D6B60] leading-relaxed font-sans max-w-3xl">
                          <span className="font-semibold text-[#3D4C40]">O que os participantes irão aprender ao final da atividade:</span>{" "}
                          {session.learningOutcomes}
                        </p>
                      )}
                    </div>
          ...
          <div className="bg-[#004B23] rounded-[24px] p-8 md:p-12 text-white shadow-xl text-center space-y-6 flex flex-col items-center max-w-4xl mx-auto pt-16 mt-8">
            ...
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-sm md:text-base text-white/80 leading-relaxed font-sans">
                Submeta sua proposta de palestra, tutorial ou lightning talk! Buscamos conteúdo diverso, de todos os níveis, sobre Python e tecnologia.
              </p>
            </div>
