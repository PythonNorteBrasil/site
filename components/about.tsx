...
export function About() {
  ...
  return (
    <section
      id="sobre"
      className="min-h-[100vh] lg:min-h-[calc(100vh-3.5rem)] flex items-center py-10 md:py-15 bg-[#FAF7F0] scroll-mt-0"
    >
      <div className="container mx-auto px-5 md:px-4 w-full">
