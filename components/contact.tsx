        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto text-foreground/80 font-medium pt-2">
              Dúvidas, sugestões ou propostas de parceria? Mande sua mensagem ou
              fale em nossos canais.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-3xl border border-black/5 bg-white p-6 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-base font-bold text-foreground font-oferta mb-1">
                Telegram
              </h3>
              <a
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label
                    htmlFor="name"
                    className="font-bold text-xs md:text-sm text-foreground/80"
                  >
                    Nome completo
                  </Label>
                  <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="subject"
                      className="rounded-xl border-black/10 py-5 focus-visible:ring-brand-orange text-foreground/75"
                    >
